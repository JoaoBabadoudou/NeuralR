...
# Let's jump in our first Neural Network


##### Initialization of parameter values
initialisation <- function(n0, n1, n2, X) {
  W1 = matrix(data = c(0.1),
              nrow = n1,
              ncol = n0)
  b1 = vector("numeric",  n1)
  W2 = matrix(data = c(0.1),
              nrow = n2,
              ncol = n1)
  b2 = vector("numeric",  n2)
  parametres <- list(W1 = W1,
                     b1 = b1,
                     W2 = W2,
                     b2 = b2)
  return(parametres)
...
predictss <- function(X, parametres) {
